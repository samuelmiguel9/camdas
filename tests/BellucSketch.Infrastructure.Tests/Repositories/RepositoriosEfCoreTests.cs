...
namespace BellucSketch.Infrastructure.Tests.Repositories;
...
public sealed class RepositoriosEfCoreTests : IAsyncLifetime
{
    ...
    private BellucSketchDbContext _contexto = null!;
    ...
    public async Task InitializeAsync()
    {
        ...
        var opcoes = new DbContextOptionsBuilder<BellucSketchDbContext>().UseSqlite(_conexao).Options;
        _contexto = new BellucSketchDbContext(opcoes);
    ...
    private BellucSketchDbContext NovoContexto() =>
        new(new DbContextOptionsBuilder<BellucSketchDbContext>().UseSqlite(_conexao).Options);
