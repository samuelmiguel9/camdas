...
namespace Camdas.Infrastructure.Tests.Persistence;
...
/// </summary>
public class CamdasDbContextTests
{
    private static CamdasDbContext CriarContexto(string nomeBanco) =>
        new(new DbContextOptionsBuilder<CamdasDbContext>().UseInMemoryDatabase(nomeBanco).Options);
