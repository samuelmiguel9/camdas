...
{
    /// <summary>4000, não mais 2500: era o teto real de nitidez pra QUALQUER entrada (foto, imagem
    /// solta ou PDF convertido) — mesmo um PDF já renderizado a 300+ DPI no servidor acabava cortado
    /// aqui, sempre no mesmo tamanho, ficando embaçado de perto e prejudicando o OCR da ferramenta de
    /// cota (pedido do usuário: "melhore a resolução de qualquer entrada"). Subimos junto com
    /// android:largeHeap (ver AndroidManifest.xml) — o mesmo motivo que limitou em 2500 (bitmap por
    /// camada nesse tamanho, em UsarResolucaoNativa) ainda se aplica, só que agora com mais memória
    /// disponível pro processo.</summary>
    public const int DimensaoMaximaPadrao = 4000;
