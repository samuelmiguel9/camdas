...
/// <summary>
/// Cliente tipado do BellucSketch.Api — cada método corresponde a um endpoint. Usa exclusivamente tipos de
/// BellucSketch.Contracts/BellucSketch.Domain (enums), nunca Application/Infrastructure.
/// </summary>
