...
/// <summary>
/// Salva um PNG na galeria (pasta Pictures/BellucSketch) via MediaStore — API a partir do Android 10
...
public sealed class SalvadorGaleriaAndroid : ISalvadorGaleria
{
    public async Task SalvarPngAsync(byte[] pngBytes, string nomeArquivo, CancellationToken ct = default)
    {
        ...
        valores.Put(MediaStore.MediaColumns.RelativePath, "Pictures/BellucSketch");
