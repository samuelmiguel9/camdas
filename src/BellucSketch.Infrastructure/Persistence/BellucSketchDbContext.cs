...
/// </summary>
public sealed class BellucSketchDbContext : DbContext
{
    public BellucSketchDbContext(DbContextOptions<BellucSketchDbContext> options) : base(options)
    {
    }
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(BellucSketchDbContext).Assembly);
